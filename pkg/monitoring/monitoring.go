...
type Consumer interface {
	...
	// V1Alpha1BuildRunFailed is a callback invoked on failed completion of a build run
	V1Alpha1BuildRunFailed(context.Context, *buildv1alpha1.BuildRun)

	// V1Alpha1BuildRunFailed is a callback invoked when a build run enters the Running state
	V1Alpha1BuildRunRunning(context.Context, *buildv1alpha1.BuildRun)

	// V1Alpha1BuildRunFailed is a callback invoked on successful completion of a build run
	V1Alpha1BuildRunSucceeded(context.Context, *buildv1alpha1.BuildRun)
}
